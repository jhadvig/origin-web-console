...
angular.module('openshiftConsole')
  .controller('StorageController', function ($routeParams, $scope, AlertMessageService, DataService, ProjectsService, $filter, LabelFilter, Logger, AuthorizationService) {
