angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/create-secret.html',
    ...
    "<osc-file-input if=\"dockercfg-file-input\" model=\"newSecret.data.dockerConfig\" drop-zone-id=\"docker-config\" dragging=\"false\" help-text=\"Upload a .dockercfg or config.json file\" show-values=\"false\" required></osc-file-input>\n" +
    "<div ui-ace=\"{\n" +
    "        mode: 'json',\n" +
    "        theme: 'eclipse',\n" +
    "        onLoad: aceLoaded,\n" +
    ...
    "<div class=\"help-block\">\n" +
    "Docker configuration file with credentials and configuration to the secured registry.\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/modals/create-secret.html',
    ...
    "<a ng-href=\"{{'creating_secrets' | helpLink}}\" target=\"_blank\"><span class=\"learn-more-inline\">Learn more&nbsp;<i class=\"fa fa-external-link\" aria-hidden=\"true\"></i></span></a>\n" +
    "</h2>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
