angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/modals/process-template.html',
    ...
    "</label>\n" +
    "<span id=\"helpBlock\" class=\"help-block\">{{updateTemplate ? \"Update the template version with the new one.\" : \"Save the template to the project. This will make the template available to anyone who can view the project.\"}}</span>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
