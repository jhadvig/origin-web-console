...
function f(a, b) {
return a.min && a.max && a.start && a.end ? !(b.pod && !b.stacked && a.samples < 2) :!1;
}
function g(a, b) {
...
return c ? a ? m ? !0 :n ? !1 :b.get(c).then(function() {
return m = !0, !0;
}, function() {
return n = !0, !1;
}) :!0 :!1;
...
var d = function(a) {
return a.name ? a.kind && "Service" !== a.kind ? !1 :!a.namespace || a.namespace === b :!1;
};
...
return "Succeeded" === a.status.phase || "Terminated" === a.status.phase || "Failed" === a.status.phase ? !1 :B(a, "openshift.io/deployer-pod-for.name") ? !1 :A(a, "openshift.io/build.name") ? !1 :"slave" !== B(a, "jenkins");
}, L = function() {
...
return W(a) ? z(a) ? void V(a) :void T(a) :void 0;
}));
}, Y = function() {
...
title:"Next Steps"
} ], a.parameters = g.getParams(), g.clearParams(), n.get(c.project).then(_.spread(function(b, e) {
function g(a) {
var b = [];
...
return a.project = b, a.breadcrumbs[0].title = k("displayName")(b), u && (o(c) || p(c)) ? (q.push(d.watch("buildconfigs", e, function(b) {
...
p() ? f.path("project/" + encodeURIComponent(this.projectName) + "/create/fromimage") :f.path("project/" + encodeURIComponent(this.projectName) + "/create/fromtemplate");
...
function p() {
return h.metricsError ? !1 :h.deployment ? !0 :h.pod && (x || _.get(h, "options.selectedContainer"));
}
function q(a, b, c) {
h.noData = !1;
